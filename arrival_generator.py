...
SCHEDULES: List[ScheduleConfig] = [
    ScheduleConfig(arrival_rate=0.28, length=1200, query_dir="queries/extreme_aws/greedy"),
    ScheduleConfig(arrival_rate=0.28, length=1200, query_dir="queries/extreme_aws/all"),
