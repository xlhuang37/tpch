...
SCHEDULES: List[ScheduleConfig] = [
    ScheduleConfig(arrival_rate=0.24, length=60, query_dir="queries/extreme_aws/greedy"),
    ScheduleConfig(arrival_rate=0.24, length=60, query_dir="queries/extreme_aws/default"),
