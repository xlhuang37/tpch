...
SCHEDULES: List[ScheduleConfig] = [
    # # Load Config
    ScheduleConfig(load=36, ratio=1.0, length=180, query_type="greedy", p_size=330, np_size=87),
    ScheduleConfig(load=36, ratio=1.0, length=180, query_type="default", p_size=330, np_size=87),
    # # 
