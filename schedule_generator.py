...
SCHEDULES: List[ScheduleConfig] = [
    # Load Config
    ScheduleConfig(load=36, ratio=1.0, length=240, query_type="greedy", p_size=1200, np_size=60),
    ScheduleConfig(load=24, ratio=1.0, length=240, query_type="greedy", p_size=1200, np_size=60),
    ScheduleConfig(load=12, ratio=1.0, length=240, query_type="greedy", p_size=1200, np_size=60),
    ScheduleConfig(load=36, ratio=1.0, length=240, query_type="default", p_size=1200, np_size=60),
    ScheduleConfig(load=24, ratio=1.0, length=240, query_type="default", p_size=1200, np_size=60),
    ScheduleConfig(load=12, ratio=1.0, length=240, query_type="default", p_size=1200, np_size=60),
    # # 
