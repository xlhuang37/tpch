...
SCHEDULES: List[ScheduleConfig] = [
    # Load Config
    ScheduleConfig(load=72, ratio=1.0, length=900, query_type="greedy", p_size=108, np_size=12),
    ScheduleConfig(load=72, ratio=1.0, length=900, query_type="default", p_size=108, np_size=12),
    ScheduleConfig(load=48, ratio=1.0, length=900, query_type="greedy", p_size=108, np_size=12),
    ScheduleConfig(load=48, ratio=1.0, length=900, query_type="default", p_size=108, np_size=12),
    ScheduleConfig(load=24, ratio=1.0, length=900, query_type="greedy", p_size=108, np_size=12),
    ScheduleConfig(load=24, ratio=1.0, length=900, query_type="default", p_size=108, np_size=12),
    # # Load Config
