...
SCHEDULES: List[ScheduleConfig] = [
    ...
    ScheduleConfig(load=36, ratio=2.0, length=240, query_type="greedy", p_size=1200, np_size=60),
    ...
    ScheduleConfig(load=36, ratio=0.5, length=240, query_type="default", p_size=1200, np_size=60),
