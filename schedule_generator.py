...
SCHEDULES: List[ScheduleConfig] = [
    # # Load Config
    ScheduleConfig(load=36, ratio=1.0, length=1200, query_type="greedy", p_size=330, np_size=87),
    ScheduleConfig(load=24, ratio=1.0, length=1200, query_type="greedy", p_size=330, np_size=87),
    ScheduleConfig(load=12, ratio=1.0, length=1200, query_type="greedy", p_size=330, np_size=87),
    ScheduleConfig(load=36, ratio=1.0, length=1200, query_type="default", p_size=330, np_size=87),
    ScheduleConfig(load=24, ratio=1.0, length=1200, query_type="default", p_size=330, np_size=87),
    ScheduleConfig(load=12, ratio=1.0, length=1200, query_type="default", p_size=330, np_size=87),
    # # 
